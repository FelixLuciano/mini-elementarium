...
section#periodic-table.row.fill.flex-centralize.px-2
  .row(:class="{'search-mode': search}")
    ...
    .col.ratio-square(style="grid-area: _1")
      .flex-centralize
        dots-horizontal-icon.pt-2(width='32' height='32' fill='#F29')

    .col.ratio-square(style="grid-area: _2")
      .flex-centralize
        dots-horizontal-icon.pt-2(width='32' height='32' fill='#92F')
...
#periodic-table
  ...
  .row
    ...
    grid-template-areas: " . g1  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  . gI" "p1 H  g2  .  .  .  .  .  .  .  .  .  . gD gE gF gG gH He" "p2 Li Be  .  .  .  .  .  .  .  .  .  . B  C  N  O  F  Ne" "p3 Na Mg g3 g4 g5 g6 g7 g8 g9 gA gB gC Al Si P  S  Cl Ar" "p4 K  Ca Sc Ti V  Cr Mn Fe Co Ni Cu Zn Ga Ge As Se Br Kr" "p5 Rb Sr Y  Zr Nb Mo Tc Ru Rh Pd Ag Cd In Sn Sb Te I  Xe" "p6 Cs Ba _1 Hf Ta W  Re Os Ir Pt Au Hg Tl Pb Bi Po At Rn" "p7 Fr Ra _2 Rf Db Sg Bh Hs Mt Ds Rg Cn Nh Fl Mc Lv Ts Og" " .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  ." " .  .  . La Ce Pr Nd Pm Sm Eu Gd Tb Dy Ho Er Tm Yb Lu  ." " .  .  . Ac Th Pa U  Np Pu Am Cm Bk Cf Es Fm Md No Lr  ."
    grid-gap: 4px
